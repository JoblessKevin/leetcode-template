...
/**
 * LeetCode 11: Container With Most Water O(n) two-pointer solution with a small optimization: skip
 * over consecutive bars that are not taller than the current side.
 */
